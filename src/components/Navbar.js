            ...
            <div className="flex items-center">
                {
                    getToken() ? 
                    <>
                        {user && <NavLink to={`/profile/${user._id}`} activeClassName="text-white" className="mr-6 bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">Profile</NavLink>}
                    ...
                    <>
                        <NavLink to={'/signup'} activeClassName="text-white" className="mr-6 bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">Signup</NavLink>
                        
                        <NavLink to={'/login'} activeClassName="text-white" className=" bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">Login</NavLink>
                    </>
                }
            </div>
        </nav>
