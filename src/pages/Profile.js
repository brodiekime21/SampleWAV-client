  ...
  {user && (
    <div className="bg-white w-full max-w-4xl rounded-lg shadow-lg p-6">
      <div className="flex items-center mb-6">
        <Avatar round="true" id="profile_image" size="100" src={user.profile_image} alt="Profile"/>
        <div className="ml-4">
     ...
     {user &&
        ...
        return (
          ...
          <img src={samp.sample_image} alt="Sample" className="w-1/6 h-20 w-20 mr-4" />
          <div className="w-4/5">
          ...
          <audio src={samp.sample_file} controls style={{ width: '80%' }}></audio>
          <button className="mr-2 bg-purple-600 text-white py-1 px-4 rounded-md hover:bg-purple-700" onClick={() => handleSampleDelete(samp._id)}>
          Delete
          </button>
          </div>
          </div>
          ...
          return (
            ...
            <div className="flex items-center bg-gray-100 mb-4 p-4 rounded-md shadow-md">
                ...
                <div className="w-4/5">
                  ...
                  <div className="flex justify-end mt-2">
                  <button onClick={()=>handlePackDelete(pack._id)} className="mr-2 bg-purple-600 text-white py-1 px-4 rounded-md hover:bg-purple-700">Delete</button>
                  </div>
                </div>
              </div>
