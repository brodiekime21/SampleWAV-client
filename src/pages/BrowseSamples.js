...
const BrowseSamples = () => {
  ...
  const filteredSamples = sample.filter(
    (sample) =>
      ...
      selectedInstruments.every((instrument) =>
        sample.instrument.includes(instrument)
      )
  );
      ...
      <div className="flex flex-wrap items-center justify-center my-4">
        ...
        <div className="flex items-center space-x-2 mr-2">
          ...
          <input
            ...
            value={bpmRange.min}
            onChange={(event) =>
              setBpmRange({ ...bpmRange, min: event.target.value })
            }
          />
          ...
          <input
            ...
            value={bpmRange.max}
            onChange={(event) =>
              setBpmRange({ ...bpmRange, max: event.target.value })
            }
          />
        </div>
