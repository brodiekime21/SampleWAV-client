              ...
              <div class="flex items-center bg-gray-100 mb-4 p-4 rounded-md shadow-md">
                ...
                <div class="w-4/5">
                  ...
                  <div class="flex justify-between items-center mt-2">
                    ...
                    <div class="flex flex-wrap">
                      {sample.genres.map((genre, index) => (
                        <span
                          key={index}
                          class="mr-2 mb-1 bg-gray-200 rounded-md py-1 px-2 text-sm"
                        >
                          {genre}
                        </span>
                      ))}
                  ...
                  <div class="flex justify-end mt-2">
                    ...
                    ></audio>
                    <a
                      href={`${baseUrl}/samples/${sample._id}/download`}
                      download
                      class="mr-2 bg-purple-600 text-white py-1 px-4 rounded-md hover:bg-purple-700"
                    >
                      Download
                    </a>
